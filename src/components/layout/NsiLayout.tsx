...
interface NsiLayoutProps {
  ...
  onUpdateObject: (id: string, patch: Partial<InfrastructureObject>) => void; onUpdateObjectType: (id: string, patch: Partial<ObjectType>) => void; onUpdateSystem: (id: string, patch: Partial<SystemEntity>) => void; onUpdateEquipment: (id: string, patch: Partial<EquipmentEntity>) => void; onReorderChildUnit: (parentEquipmentId: string, unitId: string, direction: 'up' | 'down') => void;
